...
import BackArrowLogo from './BackArrowLogo.svg';
...
const StudentProfile: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-green-50 to-purple-50 py-10 px-2">
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 relative">
        {/* Back Arrow Logo */}
        <button
          className="absolute top-4 left-4 z-10 hover:scale-105 transition-transform"
          onClick={() => navigate('/student')}
          title="Back to Dashboard"
        >
          <img src={BackArrowLogo} alt="Back to Dashboard" className="w-10 h-10 drop-shadow" />
        </button>
        <div className="flex flex-col items-center mb-6">
          <div className="relative w-24 h-24 mb-3">
            {photo ? (
              <img src={photo} alt="Profile" className="w-24 h-24 rounded-full object-cover border-4 border-blue-200 shadow" />
            ) : (
              <div className="w-24 h-24 rounded-full bg-gradient-to-br from-blue-500 to-green-500 flex items-center justify-center text-white text-3xl font-bold border-4 border-blue-200 shadow">
          ...
          <div className="flex items-center space-x-4 w-full">
            <div className="flex-1">
              ...
              <p className="text-gray-500 text-sm">Manage your student account</p>
            </div>
            {isEditing ? (
              <button
          ...
          <div>
            ...
            {isEditing ? (
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                placeholder="e.g. 2025, BSc Computer Science"
              />
            ) : (
